...
Изменения только в структуре данных. 
Удобно иметь структуру, в которой можно хранить вопрос, правильный ответ и неправильные ответы (3 шт.)
К полям этой структуры обращаться по именам. 
Создаём класс Question() (строк 21 - 29)
- фактически это даже не объект, а запись (struct/record) в терминологии Си/Паскаль,
нам не нужны методы, просто один объект, содержащий всю нужную информацию

Функция ask переделана на получение одного объекта Question (строки 138 - 148)
Изменился вызов этой функции в строках 173-174
"""
